...
export default function RideCard({
  ...
  pricePerSeat, seatsAvailable, seatsTotal, driverId, onBook,
}: Props) {
  ...
  return (
    <article className="card p-4 md:p-5 hover:shadow-md transition">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-5">
        ...
        <div className="flex items-end md:items-center gap-4 md:gap-6">
          ...
          {onBook && (
            <button className="btn-primary whitespace-nowrap" onClick={onBook}>
              Réserver
            </button>
          )}
        </div>
