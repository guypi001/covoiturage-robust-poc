...
exports.MetricsController = exports.MetricsMiddleware = exports.upstreamDurationHistogram = exports.upstreamRequestCounter = void 0;
const common_1 = require("@nestjs/common");
const client = __importStar(require("prom-client"));
const registry = client.register;
client.collectDefaultMetrics({ register: registry });
exports.upstreamRequestCounter = new client.Counter({
    name: 'bff_upstream_requests_total',
    help: 'Nombre de requêtes effectuées vers les services internes',
    labelNames: ['target', 'outcome'],
    registers: [registry],
});
exports.upstreamDurationHistogram = new client.Histogram({
